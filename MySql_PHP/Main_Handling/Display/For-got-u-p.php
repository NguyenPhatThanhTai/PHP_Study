        ...
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="../Main_Do.php" name="LoginForm" method="post">
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Type user name">
                    <input id="first-name" class="input100" type="text" name="Email" placeholder="Email of account">
                    <span class="focus-input100"></span>
                </div>

                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" value="CheckMail" name="submit">
                        Search for account
                    </button>
                </div>
            ...
            <div class="login100-more" style="background-image: url('../../Picture/910188.jpg');"></div>
        </div>
    </div>
</div>
